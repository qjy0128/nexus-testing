...
- **沙箱执行**: `scripts/sandbox-*.sh` + Python 包 `src/nexus_testing/sandbox_skill_invoke/`
...
3. **降级阶梯**: 完整定义在 `docs/references/reference-sandbox-spec.md`，DEFINITIONS.md 只做速查引用
...
- 新增脚本文件需要在 `validation-manifest.json` 中注册
...
| `docs/references/reference-security-scan.md` | 安全扫描六阶段规则 |
...
| `docs/references/reference-test-case-templates.md` | 测试用例模板与反模式 |
| `docs/references/reference-external-case-sourcing.md` | 外部测试用例获取规则 |
...
| `docs/references/reference-skill-review-framework.md` | Skill 结构与内容评审框架 |
| `docs/references/reference-agent-evaluation-methodology.md` | Agent / Skill 测试方法论 |
| `docs/references/reference-security-blacklist.md` | 安全黑名单与阻断项 |
| `docs/references/reference-expected-outputs.md` | 预期输出与交付物要求 |
| `docs/references/reference-output-verification-examples.md` | 输出校验示例 |
